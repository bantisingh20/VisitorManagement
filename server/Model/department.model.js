...
//     recordstatus: { type: DataTypes.STRING, allowNull: false, defaultValue: 'insert', },
//     statusdate: { type: DataTypes.DATE,  defaultValue: Sequelize.NOW, },
//     disabled: { type: DataTypes.ENUM('n', 'y'), allowNull: false, defaultValue: 'n',  },
//     isdeleted: { type: DataTypes.ENUM('n', 'y'), allowNull: false, defaultValue: 'n', },
